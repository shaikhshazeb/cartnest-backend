...
public class AdminProductService {
	...
	public Product editProduct(int productId, String name, String description, double price, int stock, String imageUrl) {
	    ...
	    Product updatedProduct = prod_repo.save(product);

	    // Update image if provided
	    if (imageUrl != null && !imageUrl.isEmpty()) {
	        prod_img_repo.deleteByProductId(productId);
	        ProductImage newImage = new ProductImage(updatedProduct, imageUrl);
	        prod_img_repo.save(newImage);
	    }
